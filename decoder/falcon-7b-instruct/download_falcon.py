...
download_falcon.py
══════════════════════════════════════════════════════════════
Descarga los pesos de tiiuae/falcon-7b-instruct desde HuggingFace
...
Carpeta  : decoder/falcon-7b-instruct/
...
REPO_FOLDER  = "decoder/falcon-7b-instruct"   # carpeta dentro del repo
LOCAL_DIR    = os.path.join(tempfile.gettempdir(), "falcon-7b-instruct")
...
subprocess.run(["git", "commit", "-m", f"feat: add weights for falcon-7b-instruct ({m.approxSize})"], check=True)
subprocess.run(["git", "push"], check=True)

print(f"\n✅  Pesos de falcon-7b-instruct subidos correctamente.")
